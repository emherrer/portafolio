...
#### As a _Microsoft certified data analyst_, I excel in extracting and transforming raw data into meaningful insights. My expertise spans data extraction, data wrangling, and crafting compelling visualizations through tools like SQL, Python, R and Power BI. 
